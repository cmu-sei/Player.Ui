...
import { WebhookSubscriptionPartialEditForm } from '../model/models';
...
export class WebhookService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteWebhookSubscription(id: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<any>;
    public deleteWebhookSubscription(id: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<any>>;
    public deleteWebhookSubscription(id: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<any>>;
    public deleteWebhookSubscription(id: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
    ...
    public partialUpdateWebhookSubscription(id: string, webhookSubscriptionPartialEditForm?: WebhookSubscriptionPartialEditForm, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<any> {
        ...
        return this.httpClient.patch<WebhookSubscription>(`${this.configuration.basePath}/api/webhooks/${encodeURIComponent(String(id))}`,
            webhookSubscriptionPartialEditForm,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
